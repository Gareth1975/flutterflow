...
class YourActivityWidget extends StatefulWidget {
  const YourActivityWidget({super.key});

  static String routeName = 'YourActivity';
  static String routePath = '/yourActivity';

  @override
  State<YourActivityWidget> createState() => _YourActivityWidgetState();
}

class _YourActivityWidgetState extends State<YourActivityWidget>
    with TickerProviderStateMixin {
  late YourActivityModel _model;
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      safeSetState(() {});
      _model.sahhaGetTodayFloors = await actions.sahhaGetTodayFloors();
      FFAppState().todayFloors = _model.sahhaGetTodayFloors!;
      safeSetState(() {});
    });
            ...
            flexibleSpace: FlexibleSpaceBar(
              ...
              background: ClipRRect(
                ...
                child: CachedNetworkImage(
                  ...
                  imageUrl:
                      'https://images.unsplash.com/photo-1542273917363-3b1817f69a2d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw5fHx0cmVlfGVufDB8fHx8MTc1NjMwMTQ2OHww&ixlib=rb-4.1.0&q=80&w=1080',
                  fit: BoxFit.cover,
                ),
              ),
              centerTitle: true,
