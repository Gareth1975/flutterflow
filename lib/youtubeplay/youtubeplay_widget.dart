...
import 'youtubeplay_model.dart';
export 'youtubeplay_model.dart';
...
class YoutubeplayWidget extends StatefulWidget {
  ...
  @override
  State<YoutubeplayWidget> createState() => _YoutubeplayWidgetState();
}

class _YoutubeplayWidgetState extends State<YoutubeplayWidget> {
  late YoutubeplayModel _model;
                    ...
                    child: Row(
                      ...
                      children: [
                        FlutterFlowYoutubePlayer(
                          url: widget.youtubstring.toString(),
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  10.0, 10.0, 10.0, 0.0),
                                          child: Text(
                                            'Think about:\n\n• Did this give you a new insight?\n• Did it feel relevant to your week?\n• Would you use what you learned?\n',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  font: GoogleFonts.inter(
