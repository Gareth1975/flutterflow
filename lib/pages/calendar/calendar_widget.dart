  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if ((_model.apiResult1gx?.succeeded ?? true)) {
        _model.activities = getJsonField(
          ...
          flexibleSpace: FlexibleSpaceBar(
            ...
            background: ClipRRect(
              ...
              child: CachedNetworkImage(
                ...
                imageUrl:
                    'https://images.unsplash.com/photo-1557188969-16b469a5b6c2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxiZWF1dGlmdWwlMjBvY2VhbnxlbnwwfHx8fDE3NTYyMDAwNjZ8MA&ixlib=rb-4.1.0&q=80&w=1080',
                fit: BoxFit.cover,
              ),
            ),
            centerTitle: true,
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Builder(
                builder: (context) {
                  final activitieslist = _model.activities.toList();
