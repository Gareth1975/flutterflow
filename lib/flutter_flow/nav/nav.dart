...
class AppStateNotifier extends ChangeNotifier {
  ...
  KiKonnectAuthUser? initialUser;
  KiKonnectAuthUser? user;
  ...
  void update(KiKonnectAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: SettingDeleteWidget.routeName,
          path: SettingDeleteWidget.routePath,
          builder: (context, params) => SettingDeleteWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
            name: LegalStatementsWidget.routeName,
            path: LegalStatementsWidget.routePath,
            builder: (context, params) => NavBarPage(
                  initialPage: '',
                  page: LegalStatementsWidget(),
                )),
        FFRoute(
        ...
        FFRoute(
            name: DeviceSettingsWidget.routeName,
            path: DeviceSettingsWidget.routePath,
            builder: (context, params) => NavBarPage(
                  initialPage: '',
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/unsplash-image-kB9G0wr2sHI.jpg',
                    fit: BoxFit.fill,
                  ),
                )
              : page;
