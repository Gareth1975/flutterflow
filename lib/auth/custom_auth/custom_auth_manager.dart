...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    kiKonnectAuthUserSubject.add(
      KiKonnectAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<KiKonnectAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  KiKonnectAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = KiKonnectAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    kiKonnectAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
